    ...
    public function provision(array $account, array $organization): ProvisionedTenant
    {
        return DB::transaction(function () use ($account, $organization) {
            ...
            $org = Organization::create([
                ...
                // Deviation from Platform PRD F-42: first Center is
                // customer-created in a controlled one-shot setup step; see
                // specs/saas/build-signup-free-trial.md §2.1
                'onboarding_status' => OnboardingStatus::PendingFirstCenter,
